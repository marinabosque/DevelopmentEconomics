	 ...
	 ** Histogram of betas and phis
	 preserve
		 ...
		 ** Mean and median
		 ...
		 histogram beta, title("Figure 5: Coefficient beta across households", color(black)) ///
		 xtitle ("Beta") graphregion(color(white)) bcolor(maroon)
		 graph export "${output}hist_beta_rural.png", replace
	 restore
	 ...
	 preserve
		 ...
		 ** Mean and median
		 ...
		 histogram phi, title("Figure 6: Coefficient phi across households", color(black)) ///
		 xtitle ("Phi") graphregion(color(white)) bcolor(navy)
		 graph export "${output}hist_phi_rural.png", replace
	 restore
